                ...
                <div class="mdl-color--white" style="width: auto;">
                    <table class="" style="width: 100%; padding-left: 4px; padding-bottom: 16px;">
                        ...
                        <tr class="cfg-prices-table-row">
                            ...
                            <td class="cfg-green" id="daily-statistics-avg-3days">+1%</td>
                            <td class="cfg-red" id="daily-statistics-avg-10days">-1%</td>
                        </tr>
                        <tr class="cfg-prices-table-row">
...
<script>
    ...
    function loadDailyStatistics() {
        ...
        xhttp.open("GET", "/api/daily-statistics", true);
        xhttp.send();
    }

    var selectedFuelType = 1;

    function updateFuelType(fuelTypeCode) {
        if(fuelTypeCode === undefined) {
            fuelTypeCode = 1;
        }
        selectedFuelType = fuelTypeCode;
        var fuelTypes = ["1", "2", "3", "4", "5"];
        var arrayLength = fuelTypes.length;
        var i;
        for (i = 0; i < arrayLength; i++) {
    ...
    function updateDailyStatistics() {
        ...
        document.getElementById("daily-statistics-avg-3days").innerHTML = "<i class=material-icons>" + (changeAvg3days<0 ? "trending_down" : changeAvg3days>0 ? "trending_up" : "trending_flat") + "</i>" + (changeAvg3days / 10).toFixed(2) + "&nbsp;¢ / " + (changeAvg3days<0 ? "" : "+") + changeAvg3daysPct.toFixed(2) + "%";
        ...
        document.getElementById("daily-statistics-avg-10days").innerHTML = "<i class=material-icons>" + (changeAvg10days<0 ? "trending_down" : changeAvg10days>0 ? "trending_up" : "trending_flat") + "</i>" + (changeAvg10days / 10).toFixed(2) + "&nbsp;¢ / " + (changeAvg10days<0 ? "" : "+") + changeAvg10daysPct.toFixed(2) + "%";
        ...
        document.getElementById("daily-statistics-med-3days").innerHTML = "<i class=material-icons>" + (changeMed3days<0 ? "trending_down" : changeMed3days>0 ? "trending_up" : "trending_flat") + "</i>" + (changeMed3days / 10).toFixed(2) + "&nbsp;¢ / " + (changeMed3days<0 ? "" : "+") + changeMed3daysPct.toFixed(2) + "%";
        ...
        document.getElementById("daily-statistics-med-10days").innerHTML = "<i class=material-icons>" + (changeMed10days<0 ? "trending_down" : changeMed10days>0 ? "trending_up" : "trending_flat") + "</i>" + (changeMed10days / 10).toFixed(2) + "&nbsp;¢ / " + (changeMed10days<0 ? "" : "+") + changeMed10daysPct.toFixed(2) + "%";
        ...
        document.getElementById("daily-statistics-min-3days").innerHTML = "<i class=material-icons>" + (changeMin3days<0 ? "trending_down" : changeMin3days>0 ? "trending_up" : "trending_flat") + "</i>" + (changeMin3days / 10).toFixed(2) + "&nbsp;¢ / " + (changeMin3days<0 ? "" : "+") + changeMin3daysPct.toFixed(2) + "%";
        ...
        document.getElementById("daily-statistics-min-10days").innerHTML = "<i class=material-icons>" + (changeMin10days<0  ? "trending_down" : changeMin10days>0 ? "trending_up" : "trending_flat") + "</i>" + (changeMin10days / 10).toFixed(2) + "&nbsp;¢ / " + (changeMin10days<0 ? "" : "+") + changeMin10daysPct.toFixed(2) + "%";
        ...
        document.getElementById("daily-statistics-max-3days").innerHTML = "<i class=material-icons>" + (changeMax3days<0 ? "trending_down" : changeMax3days>0 ? "trending_up" : "trending_flat") + "</i>" + (changeMax3days / 10).toFixed(2) + "&nbsp;¢ / " + (changeMax3days<0 ? "" : "+") + changeMax3daysPct.toFixed(2) + "%";
        ...
        document.getElementById("daily-statistics-max-10days").innerHTML = "<i class=material-icons>" + (changeMax10days<0 ? "trending_down" : changeMax10days>0 ? "trending_up" : "trending_flat") + "</i>" + (changeMax10days / 10).toFixed(2) + "&nbsp;¢ / " + (changeMax10days<0 ? "" : "+") + changeMax10daysPct.toFixed(2) + "%";
    }
